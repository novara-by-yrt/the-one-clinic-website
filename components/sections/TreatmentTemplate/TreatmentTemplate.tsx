    ...
    <>
        ...
        <Container>
          ...
          >
            ...
            <div className={styles.heroLeft}>
              <m.span className={styles.category} variants={fadeUp}>
                {category}
              </m.span>
              ...
              <m.div className={styles.heroCta} variants={fadeUp}>
            ...
            <m.div className={styles.heroCard} variants={fadeUp}>
        ...
        <Container>
          ...
          >
            {benefits?.map((benefit) => (
              <m.div key={benefit.title} variants={fadeUp}>
      ...
      <Section variant="light" data-section-theme="light">
        <Container>
          ...
          >
            {process?.map((step) => (
              <m.li key={step.number} className={styles.processStep} variants={fadeUp}>
