...
const TREATMENTS: Treatment[] = [
  // ── Health & Wellbeing ──────────────────────────────────────────
  {
    ...
    href: '/treatments/health-screening-leicester',
    image: '/images/Health Screening.jpg',
    bg: 'linear-gradient(160deg,#141414 0%,#212121 100%)',
  },
  {
    title: 'Private GP',
    category: 'Health & Wellbeing',
    ...
    bg: 'linear-gradient(160deg,#0d1714 0%,#262626 100%)',
  },
  {
    title: 'Joint Injections',
    category: 'Health & Wellbeing',
    desc: 'Targeted injections to relieve joint pain and restore mobility quickly.',
    href: '/treatments/joint-injections-leicester',
    image: '/images/Joint Injections.jpg',
    bg: 'linear-gradient(160deg,#100d17 0%,#1b1b1b 100%)',
  },
  {
    title: 'Minor Surgery',
    category: 'Health & Wellbeing',
  ...
  },
  {
    ...
    href: '/treatments/hydrafacial-keravive-leicester',
    bg: 'linear-gradient(160deg,#0d1317 0%,#1f1f1f 100%)',
  },
  {
    title: 'Morpheus8',
  ...
  },
  {
    ...
    href: '/treatments/vampire-facial-leicester',
    bg: 'linear-gradient(160deg,#170d10 0%,#1c1c1c 100%)',
  },
  {
    ...
    bg: 'linear-gradient(160deg,#0d1117 0%,#202020 100%)',
  },
  {
    title: 'Skin Analysis',
    category: 'Medical Aesthetics',
    ...
    bg: 'linear-gradient(160deg,#161616 0%,#202020 100%)',
  },
  {
  ...
  },
  {
    ...
    bg: 'linear-gradient(160deg,#0d1417 0%,#1f1f1f 100%)',
  },
  {
    title: 'Skin Lesion Removal',
    category: 'Medical Aesthetics',
    desc: 'Safe removal of benign skin lesions by experienced medical professionals.',
    href: '/treatments/skin-lesions-leicester',
    bg: 'linear-gradient(160deg,#171512 0%,#232323 100%)',
  },
  {
    title: 'Exosome Therapy',
    category: 'Medical Aesthetics',
    desc: 'Cutting-edge regenerative medicine harnessing exosomes to rejuvenate and repair skin.',
    href: '/treatments/regenerative-medicine-exosome-therapy-leicester',
    bg: 'linear-gradient(160deg,#161616 0%,#232323 100%)',
  },
  {
    ...
    bg: 'linear-gradient(160deg,#0f0d17 0%,#1d1d1d 100%)',
  },
  {
    title: 'Cool Bleph',
    category: 'Medical Aesthetics',
    ...
    bg: 'linear-gradient(160deg,#0d1017 0%,#1e1e1e 100%)',
  },
  {
    title: 'COOL Glow Peel',
    category: 'Medical Aesthetics',
    desc: 'Full-face glow peel for brighter, smoother skin with zero downtime.',
    href: '/treatments/cool-glow-full-face-leicester',
  ...
  },
  {
    ...
    href: '/treatments/cool-scar-lift-leicester',
    bg: 'linear-gradient(160deg,#101714 0%,#252525 100%)',
  },
  {
    title: 'Mole Removal',
    category: 'Medical Aesthetics',
    desc: 'Safe and precise mole removal by experienced clinicians for peace of mind.',
    href: '/treatments/mole-removal-leicester',
    bg: 'linear-gradient(160deg,#0d1117 0%,#232323 100%)',
  },
  {
    ...
    href: '/treatments/laser-mole-removal-leicester',
    bg: 'linear-gradient(160deg,#0d1714 0%,#262626 100%)',
  },
  {
    ...
    href: '/treatments/laser-snoring-treatment-leicester',
    bg: 'linear-gradient(160deg,#171014 0%,#1f1f1f 100%)',
  },
  {
    title: 'Laser Vaginal Rejuvenation',
    category: 'Medical Aesthetics',
    desc: 'Non-invasive laser treatment to restore comfort and confidence with no downtime.',
    href: '/treatments/laser-vaginal-leicester',
    bg: 'linear-gradient(160deg,#17100d 0%,#202020 100%)',
  },
  {
    ...
    href: '/treatments/iv-drip-therapy-leicester',
    bg: 'linear-gradient(160deg,#0d1317 0%,#1e1e1e 100%)',
  },
  {
    ...
    bg: 'linear-gradient(160deg,#171510 0%,#242424 100%)',
  },
  {
    title: 'Body Confidence Package',
    category: 'Medical Aesthetics',
  ...
  },
  {
    ...
    href: '/treatments/lipoma-removal-leicester',
  ...
  },
  {
    ...
    bg: 'linear-gradient(160deg,#111111 0%,#1a1a1a 100%)',
  },
];
