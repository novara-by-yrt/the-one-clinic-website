    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: 'GP Home Visits Leicester',                              href: '/treatments/gp-home-visits-leicester' },
          { label: 'Travel Vaccine & Immunisations',                        href: '/treatments/travel-vaccine-leicester' },
          { label: 'Weight Management',                                     href: '/treatments/weight-management-leicester' },
          { label: 'Medical Insurance Examination',                         href: '/treatments/medical-insurance-leicester' },
          { label: 'Dermatologist Leicester',                               href: '/treatments/dermatologist-leicester' },
          { label: "Men's Health",                                          href: '/treatments/mens-health-leicester' },
      ...
      },
      {
        ...
        items: [
          { label: 'Dermal Fillers',                            href: '/treatments/dermal-filler-leicester' },
          { label: 'Lumecca IPL',                               href: '/treatments/ipl-leicester' },
          { label: 'HydraFacial Keravive',                     href: '/treatments/hydrafacial-keravive-leicester' },
          { label: 'Morpheus8',                                 href: '/treatments/morpheus8-leicester' },
          { label: 'Wrinkle Relaxing Injections',               href: '/treatments/wrinkle-relaxing-injections-leicester' },
          { label: 'Hydrafacial Leicester',                     href: '/treatments/hydrafacial-leicester' },
          { label: 'Vampire Facial',                            href: '/treatments/vampire-facial-leicester' },
          { label: 'Chemical Peels',                            href: '/treatments/chemical-peels-leicester' },
          { label: 'Skin Analysis, Life Viz 3D Camera',         href: '/treatments/skin-analysis-leicester' },
          { label: 'Body Contouring',                           href: '/treatments/body-contouring-leicester' },
          { label: 'Endolift Laser',                            href: '/treatments/endolift-laser-leicester' },
          { label: 'Profhilo',                                  href: '/treatments/profhilo-leicester' },
          ...
          { label: 'Acne Scar Removal Leicester',               href: '/treatments/laser-acne-scar-treatment-leicester' },
          { label: 'Pigmentation Treatment Leicester',         href: '/treatments/hyperpigmentation-clinic-leicester' },
          { label: 'Regenerative Medicine, Exosome Therapy',   href: '/treatments/regenerative-medicine-exosome-therapy-leicester' },
          { label: 'Regenerative Medicine, Polynucleotides',   href: '/treatments/polynucleotides-leicester' },
          { label: 'Cool Bleph',                                href: '/treatments/cool-bleph-leicester' },
          { label: 'COOL Glow Peel (Full Face)',                href: '/treatments/cool-glow-full-face-leicester' },
          { label: 'Cool Scar Lift',                            href: '/treatments/cool-scar-lift-leicester' },
          { label: 'Mole Removal',                              href: '/treatments/mole-removal-leicester' },
          { label: 'Laser Mole Removal',                        href: '/treatments/laser-mole-removal-leicester' },
          { label: 'Laser Snoring Treatment',                   href: '/treatments/laser-snoring-treatment-leicester' },
          { label: 'Laser Vaginal Rejuvenation',                href: '/treatments/laser-vaginal-leicester' },
          { label: 'IV Drip Therapy',                           href: '/treatments/iv-drip-therapy-leicester' },
          { label: 'Deep Laser Resurfacing',                    href: '/treatments/deep-laser-resurfacing-leicester' },
