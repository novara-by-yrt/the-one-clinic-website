 ...
 * stands down for V1Header?"), and the two answers differ: /v2 wants
 * the normal footer but keeps the site Header, and adding it to
 * V1_ROUTES would leave the page with no navigation at all.
 *
 ...
 * desktop widths too.
 */
export const FLOW_FOOTER_ROUTES = new Set<string>(['/v1', '/v2']);
