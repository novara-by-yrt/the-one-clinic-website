 ...
 * stands down for V1Header?"), and the two answers differ: /v2 and /v3
 * want the normal footer but keep the site Header, and adding them to
 * V1_ROUTES would leave those pages with no navigation at all.
 *
