...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'The scan itself takes only a few minutes. Your clinician will then walk you through the detailed report and discuss which treatments would best address your individual skin concerns.',
  },
  {
  ...
  return (
    <>
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                3D Skin Analysis in Leicester
              </motion.h1>

              <motion.p className={styles.heroDesc} variants={fadeUp}>
                Precision skin imaging with the Life Viz 3D camera. Understand your skin at a clinical level and build a truly personalised treatment plan.
              </motion.p>
          ...
          >
            <motion.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <motion.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <h2 className={styles.combinedHeading}>What is the Life Viz 3D Skin Analysis?</h2>
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="Skin analysis consultation at The One Clinic"
                fill
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why Life Viz</motion.p>
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book skin analysis">
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Understand Your Skin.<br />Transform Your Results.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book a 3D skin analysis consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Skin analysis cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>Skin Analysis Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £50</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Often included as part of a treatment consultation. Full details provided when you book.
            </motion.p>
            <motion.div variants={fadeUp}>
