...
const OVERVIEW_POINTS = [
  'Stimulates deep collagen and elastin production for skin renewal',
  'Reduces fine lines, improves skin texture, and restores radiance',
  'Accelerates healing when combined with laser or microneedling',
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'Exosomes are typically delivered into the skin via microneedling, mesotherapy, or topical application immediately following a treatment such as laser resurfacing or Morpheus8. The microchannels created by these procedures allow deep penetration for maximum effect.',
  },
  {
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.p className={styles.heroDesc} variants={fadeUp}>
                Cutting-edge regenerative medicine to stimulate deep skin renewal, accelerate healing, and restore radiance at a cellular level.
              </motion.p>
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why Exosome Therapy</motion.p>
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              The Future of Skin<br />Renewal Is Here.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book an exosome therapy consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Exosome therapy cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>Exosome Therapy Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £200</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies by treatment protocol and whether combined with another procedure. Full details at your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
