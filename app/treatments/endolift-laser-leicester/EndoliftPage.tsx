  ...
  return (
    <>
      ...
      <Section variant="light" data-section-theme="light" className={styles.howSection}>
        <Container>
          ...
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.howCoversLabel} variants={fadeUp}>Endolift Addresses</m.p>
      ...
      <BeforeAfterSlideshow
        heading={"Endolift Before & After"}
        description={"Real skin lifting and tightening results from our patients at The One Clinic, Leicester."}
        images={BA_IMAGES}
        defaultTitle={"Endolift"}
      />
