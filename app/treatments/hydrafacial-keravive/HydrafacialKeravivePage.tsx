...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'HydraFacial Keravive is a completely non-surgical, painless scalp treatment. Most patients find it deeply relaxing, with no downtime and no recovery period required.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'Clinical studies demonstrate that HydraFacial Keravive measurably improves scalp health, hair density, and hair thickness over a course of treatment.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const OVERVIEW_POINTS = [
  'Cleanses, exfoliates, and hydrates the scalp in a single session',
  'Infuses growth factors and peptides to nourish hair follicles',
  'Suitable for hair thinning, dry scalp, and general scalp health',
...
const FAQS = [
  ...
  {
    question: 'Who is Keravive suitable for?',
    answer:
      'Keravive is suitable for both men and women experiencing hair thinning, scalp dryness, oiliness, or general scalp concerns. It is also popular as a preventative treatment to maintain scalp health. A consultation is included to ensure it is the right option for you.',
  },
  {
...
export default function HydrafacialKeravivePage() {
  return (
    <>
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                HydraFacial Keravive in Leicester
              </motion.h1>
      ...
      {/* ════════════════════════════════════════
          3. WHAT IS HYDRAFACIAL KERAVIVE?
      ════════════════════════════════════════ */}
          ...
          >
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="HydraFacial Keravive consultation at The One Clinic"
                fill
