        ...
        <Container className={styles.whiteBgContent}>
          ...
          >
            ...
            <m.p className={styles.beforeAfterSubheading} variants={fadeUp}>
              Real lip enhancement, dermal filler, and non-surgical rhinoplasty results from our patients at The One Clinic, Leicester.
            </m.p>
          </m.div>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Dermal filler cost">
        <Container>
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.costBannerEyebrow} variants={fadeUp}>Dermal Filler Pricing at The One Clinic</m.p>
