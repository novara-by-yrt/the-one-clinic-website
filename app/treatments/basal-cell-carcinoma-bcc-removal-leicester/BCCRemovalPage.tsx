...
const RELATED = [
  ...
  { title: 'Skin Lesion Removal',       href: '/treatments/skin-lesion',            desc: 'Expert excision of cysts, lumps, and benign skin lesions under local anaesthetic.' },
  { title: 'Lipoma Removal',            href: '/treatments/lipoma-removal',         desc: 'Minor surgical removal of fatty lumps with discreet, well-planned scarring.' },
