...
const FAQS = [
  {
    ...
    answer:
      'A basal cell carcinoma (BCC) is the most common form of skin cancer, arising from the basal cells in the deepest layer of the epidermis. BCCs are typically slow-growing and rarely spread to other parts of the body, but they must be treated promptly to prevent local tissue damage. They most commonly appear on sun-exposed areas such as the face, neck, and ears.',
  },
  {
    question: 'How is BCC removal performed?',
    answer:
      'BCC removal is performed under local anaesthetic as a minor surgical procedure. The lesion is excised along with a small margin of surrounding healthy tissue to ensure complete removal. The wound is then closed with sutures. The removed tissue is routinely sent to a histopathology lab to confirm clear margins and verify the diagnosis.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'No referral is required. You can book directly with The One Clinic for an assessment. Our team will examine the lesion, discuss your history, and recommend the most appropriate course of action. If surgical removal is indicated, this can be arranged promptly.',
  },
];
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="BCC Removal Leicester, hero"
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Basal Cell Carcinoma (BCC) Removal in Leicester
              </motion.h1>
            ...
            <motion.div className={styles.heroImageWrap} variants={fadeUp}>
              <Image
                ...
                alt="BCC removal surgery at The One Clinic Leicester"
                fill
                priority
          ...
          >
            <motion.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <motion.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <h2 className={styles.combinedHeading}>What is Basal Cell Carcinoma Removal?</h2>
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="BCC removal consultation at The One Clinic"
                fill
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why Choose The One Clinic</motion.p>
            <motion.h2 className={styles.headingDark} variants={fadeUp}>
              The Benefits of Private BCC Removal
            </motion.h2>
          </motion.div>
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book BCC removal">
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Don&apos;t Wait.<br />Get Expert Care Today.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book a BCC removal consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="BCC removal cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>BCC Removal Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £300</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies depending on the size and location of the lesion. Full details at your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
