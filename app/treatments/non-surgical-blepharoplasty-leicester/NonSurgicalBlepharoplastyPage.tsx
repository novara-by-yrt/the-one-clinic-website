...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'Most patients experience only mild redness and swelling for a few days following treatment. There is no requirement for general anaesthetic, and the majority of patients return to normal activities quickly.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export default function NonSurgicalBlepharoplastyPage() {
  return (
    <>
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Non-Surgical Blepharoplasty in Leicester
              </motion.h1>
      ...
      {/* ════════════════════════════════════════
          3. WHAT IS NON-SURGICAL BLEPHAROPLASTY?
      ════════════════════════════════════════ */}
          ...
          >
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="Blepharoplasty consultation at The One Clinic"
                fill
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why Choose Non-Surgical</motion.p>
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book non-surgical blepharoplasty">
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Brighter Eyes.<br />No Surgery Required.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book a non-surgical blepharoplasty consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Non-surgical blepharoplasty cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>Non-Surgical Blepharoplasty Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £400</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies depending on the area treated and the technology used. Full details at your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
