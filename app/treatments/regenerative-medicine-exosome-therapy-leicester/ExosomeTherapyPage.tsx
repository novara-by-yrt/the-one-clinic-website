...
const RELATED = [
  ...
  { title: 'NCTF 135 HA',               href: '/treatments/nctf-135-ha-leicester',       desc: 'Advanced bio-revitalisation for deep hydration and collagen stimulation.' },
      ...
      <Section variant="light" data-section-theme="light" className={styles.howSection}>
        <Container>
          ...
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.howCoversLabel} variants={fadeUp}>Exosome Therapy Addresses</m.p>
