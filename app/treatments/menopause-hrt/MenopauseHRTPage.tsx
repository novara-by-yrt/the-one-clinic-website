...
const RELATED = [
  { title: "Women's Health",              href: '/treatments/womens-health',        desc: 'Comprehensive women\'s health services including gynaecological consultations.' },
  { title: 'Health Screening',            href: '/treatments/health-screening',     desc: 'Thorough private health checks and screening packages for peace of mind.' },
  ...
  { title: 'Private GP',                  href: '/treatments/private-gp',           desc: 'Same-day private GP appointments for a wide range of medical concerns.' },
];
