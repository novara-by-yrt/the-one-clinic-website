...
const RELATED = [
  { title: 'Private GP Consultation', href: '/treatments/private-gp-leicester',            desc: 'Fast-access private GP appointments for a wide range of health concerns.' },
  { title: 'Health Screening',        href: '/treatments/health-screening-leicester',       desc: 'Comprehensive private health checks tailored to your age and lifestyle.' },
  { title: "Men's Health",            href: '/treatments/mens-health-leicester',            desc: 'Specialist private care for male health, hormones, and wellbeing.' },
  { title: "Women's Health",          href: '/treatments/womens-health-leicester',          desc: 'Expert private care for female health across all life stages.' },
];
      ...
      <Section variant="light" data-section-theme="light" className={styles.howSection}>
        <Container>
          ...
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.howCoversLabel} variants={fadeUp}>The Service Includes</m.p>
