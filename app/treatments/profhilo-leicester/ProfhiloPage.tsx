...
const RELATED = [
  ...
  { title: 'Wrinkle Relaxing Injections', href: '/treatments/wrinkle-relaxing-injections-leicester', desc: 'Smooth dynamic lines naturally for a rested, refreshed appearance.' },
  { title: 'HydraFacial',                 href: '/treatments/hydrafacial-leicester',       desc: 'Multi-step facial for instant hydration and glow with zero downtime.' },
  { title: 'Morpheus8',                   href: '/treatments/morpheus8-leicester',         desc: 'Advanced RF microneedling for skin tightening and collagen renewal.' },
];
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Profhilo cost">
        <Container>
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.costBannerEyebrow} variants={fadeUp}>Profhilo Pricing at The One Clinic</m.p>
