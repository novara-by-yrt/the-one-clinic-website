...
const JOURNEY_STEPS = [
  {
    ...
    desc: 'Our doctor examines your nail and surrounding skin, discusses your symptoms, and confirms the correct treatment approach. A personalised procedure plan is created.',
  },
  {
    n: '02',
    title: 'Procedure Day',
    desc: 'A local anaesthetic ring block is administered to fully numb the toe. The offending nail edge is then carefully removed down to the root.',
  },
  {
    n: '03',
    title: 'Phenolisation & Dressing',
    desc: 'Phenol is applied to the nail matrix to destroy the cells that grow the ingrown section, preventing regrowth. The toe is dressed with a sterile bandage.',
  },
  {
    n: '04',
    title: 'Full Recovery',
...
const APPROACH_CARDS = [
  {
    ...
    desc: 'We administer a ring block injection at the base of the toe. Within minutes the entire toe is fully numb, ensuring the procedure is completely pain-free from start to finish.',
  },
  {
    eyebrow: '02',
    title: 'Nail Edge Removal & Phenolisation',
    desc: 'The ingrown edge is carefully lifted and removed down to the root. Phenol is then applied directly to the nail matrix in that corner, permanently destroying the cells that cause regrowth.',
  },
  {
    eyebrow: '03',
    title: 'Sterile Dressing & Discharge',
    desc: 'The wound is dressed with a sterile bandage. You receive full aftercare instructions, a dressing kit, and a follow-up appointment. Most patients walk out within an hour of arrival.',
  },
];
...
const TREATED_BENEFITS = [
  {
    ...
    desc: 'The pressure and pain caused by the nail spike resolve as soon as the anaesthetic wears off and the offending edge has been removed.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    title: 'Walk Away Same Day',
    desc: 'There is no general anaesthetic, no overnight stay, and no surgical incision. You walk out of the clinic on the same day and can return to light activities immediately.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M3 21h18"/>
        <path d="M5 21V7l8-4v4"/>
  ...
  {
    title: 'No General Anaesthetic',
    desc: 'The procedure uses only a local ring block, eliminating the risks and recovery associated with general anaesthetic or hospital admission.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/>
        <polyline points="17 6 23 6 23 12"/>
...
const CONDITIONS_CARDS = [
  {
    ...
    desc: 'Thickened, discoloured, or brittle nails caused by fungal overgrowth. Treated with topical or oral antifungal therapy.',
  },
  {
    title: 'Subungual Haematoma',
    desc: 'Blood pooling under the nail following trauma, causing pressure and pain. Relieved by trephination when clinically indicated.',
  },
  {
    title: 'Nail Trauma',
    desc: 'Damage to the nail plate or nail bed from direct injury. Assessed and managed to prevent infection or permanent deformity.',
  },
  {
    title: 'Plantar Wart',
    desc: 'A verruca on the sole of the foot caused by HPV, often painful underfoot. Treated with cryotherapy or surgical excision.',
  },
  {
    title: 'Corns & Calluses',
    desc: 'Hardened skin formed in response to pressure or friction. Professionally debrided and prevented with footwear advice.',
  },
  {
    title: 'Toe Deformity',
    desc: 'Conditions such as hammer toe or claw toe that cause rubbing and pain. Assessed by our doctors and referred appropriately.',
  },
  {
    title: 'Other Minor Surgery',
    desc: 'We also offer haemorrhoid removal, skin lesion excision, lipoma removal, and other minor surgical procedures in our clinic.',
  },
];
...
const FAQS = [
  ...
  {
    question: 'Do I need antibiotics before the procedure?',
    answer:
      'Not always. If you have a mild localised infection, removing the nail spike usually allows it to resolve. For significant or spreading infection our doctor may prescribe antibiotics prior to or alongside the procedure.',
  },
];
...
export default function IngownToenailRemovalPage() {
  ...
  return (
    <>
      ...
      {/* ════════════════════════════════════════
          2. WHAT IS INGROWN TOENAIL REMOVAL?
      ════════════════════════════════════════ */}
          ...
          >
            ...
            <motion.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <motion.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <h2 className={styles.combinedHeading}>What is Ingrown Toenail Removal?</h2>
                ...
                <p className={styles.combinedDesc}>
                  ...
                  anaesthetic. The offending nail edge is carefully removed down to the root,
                  and a chemical (phenol) is applied to permanently destroy the nail matrix in
                  that corner. This prevents regrowth and resolves the problem for good.
                </p>
              </motion.div>
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.combinationIntroText} variants={fadeUp}>
              At The One Clinic, we use a precise three-step surgical method that relieves pain
              immediately and prevents the problem from ever returning.
            </motion.p>
          </motion.div>
      ...
      <Section variant="light" data-section-theme="light" className={styles.journeySection}>
        <Container>
          ...
          <motion.ol
            ...
            whileInView="show"
            viewport={VIEWPORT}
            aria-label="Ingrown toenail removal treatment journey steps"
          >
      ...
      <Section variant="dark" data-section-theme="dark">
        <Container>
          ...
          >
            ...
            <motion.p className={styles.eligibilityIntro} variants={fadeUp} style={{ marginTop: '32px' }}>
            ...
            <motion.p className={styles.eligibilityClosing} variants={fadeUp}>
              If you are unsure, book a consultation and our doctor will confirm whether
      ...
      <Section variant="light" data-section-theme="light" className={styles.howSection}>
        <Container>
          ...
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.howCoversLabel} variants={fadeUp}>This Procedure Addresses</motion.p>
        ...
        <Container>
          ...
          >
            ...
            <motion.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <div className={styles.resultsAfterCardSpacer} />
              <p className={styles.resultsAfterCardNote}>
                We provide full written aftercare instructions and a follow-up appointment
                to monitor healing.
              </p>
            </motion.div>
      ...
      {/* ════════════════════════════════════════
          10. OTHER NAIL & FOOT CONDITIONS (replaces B&A)
      ════════════════════════════════════════ */}
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        <div className={styles.whiteBgWrap} aria-hidden="true">
          <Image src="/bg-image-white.png" alt="" fill className={styles.whiteBgImg} sizes="100vw" />
        ...
        <Container className={styles.whiteBgContent}>
          ...
          >
            ...
            <motion.p className={styles.beforeAfterSubheading} variants={fadeUp}>
              Beyond ingrown toenails, our doctors treat a range of nail and minor surgical
              foot conditions at our Leicester clinic.
            </motion.p>
          </motion.div>
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              No More Nail Pain.<br />Walk Freely Again.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Let our expert doctors create your personalised ingrown toenail treatment plan!
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      {/* ════════════════════════════════════════
          13. TOENAILS & CONDITIONS WE TREAT (replaces Treatable Areas)
      ════════════════════════════════════════ */}
      <Section variant="dark" data-section-theme="dark" className={styles.conditionsSection}>
        <Container>
          ...
          >
            ...
            >
              <p className={styles.areasGroupLabel}>Nail Types</p>
          ...
          >
            <motion.div className={styles.clinicIntroLeft} variants={fadeUp}>
              ...
              <h2 className={styles.combinedHeading}>
                Best Ingrown Toenail<br />Removal in Leicester
              </h2>
            </motion.div>
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              The final price depends on your personalised treatment plan, including whether
              one or both toes require treatment. Exact costs will be confirmed during your
