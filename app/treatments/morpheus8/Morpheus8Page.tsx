...
const BENEFITS = [
  ...
  {
    title: 'Works on Face & Body',
    desc: 'Treat the face, neck, jowls, abdomen, and arms. Morpheus8 remodels skin and fat wherever laxity or texture concerns exist.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'Unlike laser treatments, Morpheus8 is safe for all skin tones. The fractional RF energy works at depth without targeting surface pigment.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'No referral is needed. You can book directly with us. A full consultation and skin assessment is carried out before any treatment to confirm suitability.',
  },
];
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Morpheus8 in Leicester
              </motion.h1>

              <motion.p className={styles.heroDesc} variants={fadeUp}>
                Advanced RF microneedling for skin tightening, collagen renewal, and facial contouring. Visible results, minimal downtime.
              </motion.p>
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why Morpheus8</motion.p>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Morpheus8 cost">
        <Container>
          ...
          >
            ...
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>Treatments From £300</motion.p>
