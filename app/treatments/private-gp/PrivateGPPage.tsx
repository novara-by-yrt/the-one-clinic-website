...
const BENEFITS = [
  {
    ...
    desc: 'See a qualified GP the same day or next day. Receive a diagnosis, prescription, or referral without delay.',
    icon: (
  ...
  },
  {
    ...
    desc: 'See the same GP at every visit. Build an ongoing relationship with a doctor who truly knows your medical history.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'In most cases, same-day or next-day appointments are available. Simply contact The One Clinic and our team will book you in at the earliest convenient time.',
  },
  {
    question: 'Is a private GP suitable for ongoing care?',
    answer:
      'Yes. Our private GP service is ideal for both one-off acute consultations and long-term management of chronic conditions such as diabetes, hypertension, and mental health concerns. We provide continuity of care, meaning you can see the same doctor at each visit.',
  },
  {
          ...
          >
            ...
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Private GP Services in Leicester
              </motion.h1>
          ...
          >
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="Private GP doctor consultation at The One Clinic"
                fill
        ...
        <Container className={styles.whiteBgContent}>
          ...
          >
            ...
            <motion.h2 className={styles.headingDark} variants={fadeUp}>
              The Benefits of Private GP Care
            </motion.h2>
          </motion.div>
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies depending on the consultation type and duration. Full details will
