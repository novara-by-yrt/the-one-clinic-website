...
const RELATED = [
  ...
  { title: 'Minor Surgery',       href: '/treatments/minor-surgery',       desc: 'A wide range of minor surgical procedures carried out in clinic.' },
      ...
      <Section variant="light" data-section-theme="light" className={styles.howSection}>
        <Container>
          ...
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.howCoversLabel} variants={fadeUp}>Removal Methods Available</motion.p>
