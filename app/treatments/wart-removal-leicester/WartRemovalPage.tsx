...
const BENEFITS = [
  {
    ...
    desc: 'Professional wart removal is significantly more effective than over-the-counter treatments. Most warts and verrucas are treated in a single short session by our clinical team.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Skip the NHS queue. At The One Clinic, same-day and next-day appointments are regularly available with no GP referral required.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const OVERVIEW_POINTS = [
  'Removes common warts, plantar warts (verrucas), and skin tags',
  'Clinical assessment included before every treatment',
  'Choice of cryotherapy, cauterisation, or surgical removal',
  'No waiting lists and no GP referral required',
];

const FAQS = [
  {
    question: 'What wart treatments are available?',
    answer:
      'At The One Clinic we offer cryotherapy (liquid nitrogen freezing), cauterisation (heat treatment), and surgical excision. The most appropriate method depends on the size, type, and location of your wart, which will be assessed at your consultation before treatment is carried out.',
  },
  {
  ...
  return (
    <>
          ...
          >
            <motion.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <motion.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <h2 className={styles.combinedHeading}>What is Wart Removal?</h2>
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="Wart removal consultation at The One Clinic"
                fill
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book wart removal">
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book a wart removal consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Wart removal cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>Wart Removal Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £100</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies by treatment method and number of warts. Full details provided at your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
