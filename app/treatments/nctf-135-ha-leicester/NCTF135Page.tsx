...
const RELATED = [
  { title: 'Skin Analysis',      href: '/treatments/skin-analysis-leicester',             desc: 'Detailed diagnostic assessment to understand your skin\'s needs and plan treatment.' },
      ...
      <Section variant="light" data-section-theme="light" className={styles.howSection}>
        <Container>
          ...
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.howCoversLabel} variants={fadeUp}>NCTF 135 HA Addresses</m.p>
