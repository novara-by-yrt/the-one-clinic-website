...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'AlumierMD is backed by clinical research and trusted by medical professionals worldwide. The range targets ageing, pigmentation, acne, sensitivity, and overall skin health with proven efficacy.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const OVERVIEW_POINTS = [
  'Pharmaceutical-grade actives for real, measurable skin improvement',
  'Addresses ageing, pigmentation, acne, and sensitivity',
  'Prescribed and monitored by our clinical skin experts',
  'Available alongside in-clinic treatments for enhanced results',
];
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'AlumierMD products contain active ingredients at pharmaceutical concentrations that are not available in standard retail products. Because they are more potent, they must be prescribed by a trained clinician following a skin assessment to ensure the right products are used safely and effectively for your skin type.',
  },
  {
    question: 'What skin concerns can AlumierMD treat?',
    answer:
      'AlumierMD addresses a broad range of concerns including signs of ageing (fine lines, loss of firmness), uneven pigmentation and sun damage, acne-prone and congested skin, sensitive or rosacea-prone skin, and overall skin health and radiance. Your personalised regime will target your specific priorities.',
  },
  {
  ...
  return (
    <>
            ...
            <div className={styles.heroLeft}>
              ...
              <motion.div className={styles.heroTrust} variants={fadeUp}>
                ...
                <span className={styles.heroTrustItem}>
                  ...
                  Personalised skin prescriptions
                </span>
                <span className={styles.heroTrustDivider} aria-hidden="true" />
                <span className={styles.heroTrustItem}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          >
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="AlumierMD skin consultation at The One Clinic"
                fill
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why AlumierMD</motion.p>
            <motion.h2 className={styles.headingDark} variants={fadeUp}>
              The Benefits of AlumierMD Skincare
            </motion.h2>
          </motion.div>
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book AlumierMD skin consultation">
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Your Best Skin<br />Starts With Science.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book an AlumierMD skin consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      {/* ════════════════════════════════════════
          6. COST BANNER
      ════════════════════════════════════════ */}
      <section className={styles.costBanner} data-section-theme="dark" aria-label="AlumierMD skincare cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>AlumierMD Skincare Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £50</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Skin consultation and personalised product prescription included. Product pricing varies by regime. Full details at your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
