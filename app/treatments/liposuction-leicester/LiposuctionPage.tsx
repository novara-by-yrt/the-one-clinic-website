...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'Fat cells removed by liposuction do not return. With a stable weight and healthy lifestyle, the results can be permanent and transformative.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'Modern liposuction techniques allow precise sculpting to improve body proportions, achieving natural-looking contours tailored to your goals.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'All liposuction procedures at The One Clinic are carried out by our experienced medical team. A full consultation and assessment is included before any surgery.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const OVERVIEW_POINTS = [
  'Removes stubborn fat from abdomen, thighs, arms, and more',
  'Permanent fat cell removal with long-lasting body contouring results',
  'Personalised treatment plan tailored to your body and goals',
...
const FAQS = [
  {
    ...
    answer:
      'Liposuction is a surgical procedure that removes localised deposits of fat from specific areas of the body. A thin tube (cannula) is inserted through small incisions to suction out the fat cells. It is not a weight-loss procedure but is used to reshape and contour areas that are resistant to diet and exercise.',
  },
  {
    question: 'What areas can liposuction treat?',
    answer:
      'Liposuction can be used to treat a wide range of areas including the abdomen, flanks (love handles), thighs, upper arms, back, buttocks, and under the chin. Multiple areas can often be treated in a single session, which will be discussed during your consultation.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'No referral is needed. You can book directly with The One Clinic. A full medical consultation and assessment is carried out before any procedure to ensure liposuction is the right option for you.',
  },
];
  ...
  return (
    <>
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why Choose Liposuction</motion.p>
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book liposuction">
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book a liposuction consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Liposuction cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>Liposuction Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £2,500</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies by treatment area and number of areas. Full details provided at your personalised consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
