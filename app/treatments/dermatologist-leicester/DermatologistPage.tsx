...
const JOURNEY_STEPS = [
  ...
  },
  {
    ...
    desc: 'Your dermatologist will take a full skin, hair, and nail history, examine all affected areas, and use dermoscopy to assess any suspicious lesions in detail.',
  },
  {
    n: '03',
    title: 'Diagnosis & Tests',
    desc: 'Where needed, skin biopsies, swabs, patch testing for contact dermatitis, or other investigations are arranged promptly to confirm your diagnosis.',
  },
  {
    n: '04',
    title: 'Treatment & Follow-up',
    desc: 'A personalised treatment plan is provided, which may include topical or oral prescriptions, clinic-based procedures, or specialist referral. Follow-up appointments are scheduled as needed.',
  },
];
...
const APPROACH_CARDS = [
  {
    eyebrow: '01',
    title: 'Full Skin History & Examination',
    desc: 'We begin with a thorough consultation, reviewing your skin, hair, and nail history, current medications, and lifestyle. A head-to-toe skin examination follows, with dermoscopy of any lesions of concern.',
  },
  {
    eyebrow: '02',
    title: 'Investigations & Diagnosis',
    desc: 'Where required, we arrange skin biopsies, swabs, patch testing, or other investigations to reach a precise diagnosis. Results are reviewed promptly and discussed with you in full.',
  },
  {
    eyebrow: '03',
    title: 'Treatment Plan & Prescribing',
    desc: 'Your personalised treatment plan is developed based on your diagnosis. We have full prescribing authority for topical and systemic medications, and will refer to specialist surgical services when appropriate.',
  },
];

const ELIGIBILITY_SUITABLE = [
  'Persistent skin conditions not responding to GP treatment',
  'Unexplained rashes, hives, or skin changes',
  'Moderate to severe acne, eczema, or psoriasis',
  'Suspicious moles or lesions requiring expert assessment',
  'Hair loss (alopecia) or scalp disorders',
  'Nail disorders or recurring nail infections',
  'Contact dermatitis or patch testing requirements',
];

const ELIGIBILITY_NOT_SUITABLE = [
  'Emergency dermatology requiring immediate A&E attendance',
  'Confirmed skin cancer requiring multidisciplinary team management (we will provide referral)',
];

const TREATED_BENEFITS = [
  {
    title: 'Specialist Expertise',
    desc: 'Access a skin specialist with advanced training in dermatology, delivering diagnosis and treatment beyond standard GP-level care.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
      </svg>
  ...
  {
    title: 'No GP Referral',
    desc: 'Book directly without waiting for a GP referral. We provide rapid, self-referral access to specialist-level dermatology care.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
        <polyline points="22 4 12 14.01 9 11.01"/>
  ...
  {
    title: 'On-site Biopsies',
    desc: 'Skin biopsies and minor surgical procedures are performed in-clinic, avoiding additional hospital visits and delays.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M9 12h6M9 16h6M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2z"/>
      </svg>
  ...
  },
  {
    ...
    desc: 'Full prescribing authority for topical treatments, oral medications, and access to biologic referrals for complex inflammatory conditions.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M19 8l-4 4h3a9 9 0 0 1-9 9 9 9 0 0 1-6.4-2.7"/>
        <path d="M5 12H2a9 9 0 0 1 9-9c2.4 0 4.6.9 6.3 2.4"/>
      </svg>
    ),
  },
  {
    title: 'Comprehensive Skin Care',
    desc: 'From first consultation through to long-term management, we provide continuity of care for chronic conditions and preventive skin health.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const WHAT_TO_EXPECT = [
  {
    ...
    body: 'A thorough head-to-toe skin assessment where required, with dermoscopic examination of any moles, lesions, or areas of concern. Scalp, nail, and hair examination included as appropriate.',
    note: 'Bring a list of any medications you currently take and photos of any intermittent rashes or skin changes.',
  },
  {
    ...
    body: 'Where a diagnosis requires further evidence, we can perform skin biopsies, skin swabs, patch testing for contact dermatitis, or arrange blood tests.',
    note: 'Results are discussed with you as soon as they are available, with a clear explanation of findings and next steps.',
  },
  {
    ...
    body: 'A personalised plan covering prescription medications, skincare recommendations, lifestyle advice, clinic-based procedures, and any onward referrals required.',
    note: 'Follow-up appointments are scheduled as needed to monitor your progress and adjust your treatment as required.',
  },
];
...
const CONDITIONS_WE_TREAT = [
  ...
  {
    title: 'Psoriasis',
    desc: 'Plaque, guttate, and scalp psoriasis assessment and management, including topical therapies and referral for advanced biologic treatments where appropriate.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <path d="M4 10a9 9 0 0 1 16.8-2.3L20 10"/>
        <path d="M20 14a9 9 0 0 1-16.8 2.3L4 14"/>
      </svg>
    ),
  },
  {
    title: 'Urticaria & Hives',
    desc: 'Acute and chronic spontaneous urticaria investigated and managed with antihistamines, trigger identification, and specialist referral for refractory cases.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <circle cx="12" cy="12" r="10"/>
...
const FAQS = [
  {
    question: 'What conditions does a private dermatologist treat?',
    answer:
      'Our dermatology service covers a wide range of skin, hair, and nail conditions including acne, eczema, psoriasis, rosacea, dermatitis, urticaria (hives), fungal infections, alopecia, and suspicious moles or lesions. We also offer skin cancer screening and perform minor skin procedures such as biopsy and lesion removal.',
  },
  {
    question: 'Do I need a GP referral to see a private dermatologist?',
    answer:
      'No referral is required. You can book directly with The One Clinic. However, if you have been referred by your NHS GP or another doctor, we are happy to work in conjunction with your existing care team and share correspondence as appropriate.',
  },
  {
    question: 'How long does a dermatology consultation take?',
    answer:
      'Initial consultations are typically 30 to 45 minutes, allowing time for a thorough history, full skin examination, diagnosis, and discussion of your treatment options. Follow-up appointments are usually 20 to 30 minutes.',
  },
  {
    question: 'Can you test or biopsy suspicious moles at the clinic?',
    answer:
      'Yes. Our doctors can perform dermoscopic assessment of suspicious lesions during your consultation. Where a biopsy is recommended, this can often be arranged promptly. Results are reviewed with you and next steps, including any referral for specialist surgical management if required, are discussed clearly.',
  },
  {
    question: 'What prescription treatments are available?',
    answer:
      'We have full prescribing authority for a wide range of dermatological medications, including topical treatments, oral antibiotics, retinoids, immunosuppressants, and antifungals. Where biologic therapies are appropriate, we can facilitate onward referral to NHS or private specialist services.',
  },
  {
    question: 'How much does a private dermatology consultation cost?',
    answer:
      'Private dermatology consultations at The One Clinic start from £200. The exact cost will depend on the nature of the consultation and any procedures or investigations performed. Full pricing is confirmed when you book.',
  },
];

const RELATED = [
  { title: 'Skin Analysis',        href: '/treatments/skin-analysis-leicester',        desc: 'Advanced imaging to assess your skin health and guide your treatment plan.' },
  { title: 'Skin Lesion Removal',  href: '/treatments/skin-lesion-removal',  desc: 'Safe, precise removal of benign and suspicious skin lesions in-clinic.' },
  { title: 'AlumierMD Skincare',   href: '/treatments/alumiermd',            desc: 'Medical-grade skincare prescribed to your skin type and concerns.' },
  { title: 'Mole Removal',         href: '/treatments/mole-removal',         desc: 'Expert mole assessment and removal by our trained clinical team.' },
];
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="Private Dermatologist Leicester, hero"
            ...
            <div className={styles.heroLeft}>
              ...
              <m.div className={styles.heroTrust} variants={fadeUp}>
                <span className={styles.heroTrustItem}>
                  ...
                  Led by qualified skin specialists
                </span>
      ...
      {/* ════════════════════════════════════════
          2. WHAT IS A DERMATOLOGIST CONSULTATION?
      ════════════════════════════════════════ */}
      ...
      {/* ════════════════════════════════════════
          12. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book dermatology consultation">
        {/* Watermark logo */}
      ...
      <Section variant="dark" data-section-theme="dark" className={styles.conditionsSection}>
        <Container>
          ...
          >
            ...
            >
              <p className={styles.areasGroupLabel}>Conditions Treated</p>
              <ul className={styles.areasGroupList} role="list">
                {CONDITIONS_TREATED.map((area) => (
            ...
            >
              ...
              <ul className={styles.areasGroupList} role="list">
                {SERVICES_AVAILABLE.map((service) => (
                  <li key={service} className={styles.areasGroupItem}>
                    <span className={styles.areasItemDot} aria-hidden="true" />
                    {service}
                  </li>
                ))}
