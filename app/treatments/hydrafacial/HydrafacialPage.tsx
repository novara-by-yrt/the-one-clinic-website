...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'Regular HydraFacial sessions improve skin texture, tone, and hydration over time. A great foundation for any skincare routine.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'Yes. HydraFacial is one of the gentlest professional skin treatments available and is suitable for even the most sensitive skin types. The serums and settings can be adjusted to suit your individual needs.',
  },
  {
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.p className={styles.heroDesc} variants={fadeUp}>
                Cleanse, exfoliate, extract, and hydrate in one session. Instantly glowing skin with zero downtime.
              </motion.p>
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why HydraFacial</motion.p>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="HydraFacial cost">
        <Container>
          ...
          >
            ...
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>Treatments From £120</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies by treatment type and add-ons. Full details provided at your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
