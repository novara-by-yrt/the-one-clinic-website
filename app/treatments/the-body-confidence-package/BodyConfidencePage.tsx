...
const FAQS = [
  {
    question: 'What treatments are included in The Body Confidence Package?',
    answer:
      'The package is personalised to each patient, but typically includes a combination of body contouring, fat reduction, skin tightening, and rejuvenation treatments. Your clinician will recommend the most appropriate combination at your consultation based on your goals and anatomy.',
  },
  {
    question: 'How many sessions will I need?',
    answer:
      'The number of sessions depends on the treatments selected and the results you are looking to achieve. Most patients complete their package over a period of several weeks, with each treatment spaced to allow optimal results and recovery.',
  },
  {
    question: 'Are the treatments suitable for all body types?',
    answer:
      'Yes. The Body Confidence Package is designed to be fully inclusive and adaptable. During your consultation, our team will assess your individual needs and recommend the treatments best suited to your body type, skin, and goals.',
  },
  {
    question: 'Do I need a referral to book?',
    answer:
      'No referral is needed. You can book your consultation directly with The One Clinic. A thorough assessment is carried out at your first appointment to create your personalised treatment plan.',
  },
];
...
export default function BodyConfidencePage() {
  return (
    <>
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                The Body Confidence Package in Leicester
              </motion.h1>
            ...
            <motion.div className={styles.heroImageWrap} variants={fadeUp}>
              <Image
                ...
                alt="The Body Confidence Package at The One Clinic Leicester"
                fill
                priority
      ...
      {/* ════════════════════════════════════════
          3. WHAT IS THE BODY CONFIDENCE PACKAGE?
      ════════════════════════════════════════ */}
          ...
          >
            <motion.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <motion.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <p className={styles.combinedDesc}>
                  The Body Confidence Package is a bespoke aesthetic programme that brings together
                  the most effective body treatments available at The One Clinic. Designed to
                  address stubborn fat, skin laxity, and body contouring in a single cohesive
                  plan, it delivers transformative results guided by our expert clinical team.
                </p>
              </motion.div>
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="Body confidence package consultation at The One Clinic"
                fill
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why Choose This Package</motion.p>
            <motion.h2 className={styles.headingDark} variants={fadeUp}>
              The Benefits of The Body Confidence Package
            </motion.h2>
          </motion.div>
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book body confidence package">
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Your Body.<br />Your Confidence.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book your Body Confidence Package consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Body confidence package cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>Body Confidence Package Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £500</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing depends on the treatments included in your personalised package. Full details at your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
