...
const RELATED = [
  ...
  { title: 'Weight Management',                  href: '/treatments/weight-management-leicester',            desc: 'Clinician-led programmes for sustainable, healthy weight loss.' },
  { title: 'Blood Tests & General Health Check', href: '/treatments/health-screening-leicester',             desc: 'Diagnostic blood analysis and a broad assessment of wellbeing.' },
  { title: 'Mental Health Consultation',         href: '/treatments/mental-health-consultation-leicester',   desc: 'Compassionate support for anxiety, low mood, and stress.' },
];
      ...
      <Section variant="light" data-section-theme="light" className={styles.howSection}>
        <Container>
          ...
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.howCoversLabel} variants={fadeUp}>Screening Covers</m.p>
