...
const BENEFITS = [
  {
    ...
    desc: 'Most patients see a significant improvement after just one session. Pigmentation, redness, and sun damage visibly fade within days.',
    icon: (
  ...
  {
    title: 'Safe & Clinically Proven',
    desc: 'Lumecca is the most powerful IPL device available, used by medical professionals worldwide and delivered here by our expert clinical team.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const FAQS = [
  {
    ...
    answer:
      'Lumecca is an intense pulsed light (IPL) device that uses broad-spectrum light to target and break down pigmentation, redness, and vascular lesions in the skin. It is one of the most powerful and effective IPL systems available, delivering faster and more noticeable results than traditional light therapies.',
  },
  {
  ...
  return (
    <>
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book Lumecca IPL consultation">
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Clearer Skin Starts<br />with One Session.
            </motion.h2>
