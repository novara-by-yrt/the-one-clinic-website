...
const OVERVIEW_POINTS = [
  'Advanced laser resurfacing, Morpheus8, and microneedling options',
  'Treats all acne scar types across all skin tones',
  'Stimulates collagen for gradual, natural-looking improvement',
  ...
  return (
    <>
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Acne Scar Removal in Leicester
              </motion.h1>
        ...
        <Container className={styles.whiteBgContent}>
          ...
          >
            ...
            <motion.h2 className={styles.headingDark} variants={fadeUp}>
              The Benefits of Acne Scar Treatment at The One Clinic
            </motion.h2>
          </motion.div>
      ...
      {/* ════════════════════════════════════════
          5. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book acne scar removal">
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Smoother Skin<br />Is Possible.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book an acne scar consultation with our expert team in Leicester.
            </motion.p>
            <motion.div variants={fadeUp}>
      ...
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Acne scar removal cost">
        <Container>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.costBannerEyebrow} variants={fadeUp}>Acne Scar Treatment Pricing at The One Clinic</motion.p>
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>From £150</motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies by treatment type and number of sessions required. Full details provided at your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
