...
const APPROACH_STEPS = [
  {
    ...
    desc: 'A thorough skin consultation evaluates your skin quality, concerns, and regenerative needs. We assess hydration levels, elasticity, fine lines, and tissue damage to create a fully personalised polynucleotides protocol.',
  },
  {
    eyebrow: '02',
    title: 'Targeted Injection Protocol',
    desc: 'Pharmaceutical-grade PDRN is precisely micro-injected into the dermis across mapped treatment zones. Our advanced technique ensures optimal distribution for maximum collagen stimulation and cellular repair.',
  },
  {
    eyebrow: '03',
    title: 'Progressive Regeneration Plan',
    desc: 'A course of 3 to 4 sessions builds collagen progressively. We monitor your skin\'s response and adjust the protocol at each visit, then schedule maintenance treatments to sustain your results long term.',
  },
];
...
const JOURNEY_STEPS = [
  {
    ...
    desc: 'A detailed review of your skin quality, concerns, and goals. Your doctor assesses hydration, elasticity, and areas of concern to confirm that polynucleotides are the right choice and to build your personalised treatment plan.',
  },
  {
    n: '02',
    title: 'Treatment Preparation',
    desc: 'The skin is thoroughly cleansed and a topical numbing cream applied for complete comfort. Treatment zones are mapped and the pharmaceutical-grade PDRN solution prepared for precise delivery.',
  },
  {
    n: '03',
...
const BENEFITS = [
  {
    ...
    desc: 'PDRN molecules signal fibroblasts to activate and repair tissue at a cellular level, driving true regeneration rather than simply masking signs of ageing.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'Growth factors including VEGF and TGF-β are activated, boosting collagen and elastin production for firmer, smoother, and more resilient skin over time.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/>
        <polyline points="17 6 23 6 23 12"/>
  ...
  },
  {
    ...
    desc: 'Polynucleotides attract and retain moisture deep within the dermis, improving skin plumpness, hydration levels, and the quality of the skin barrier from within.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'Progressive collagen remodelling softens fine lines and surface wrinkles, restoring a smoother, more youthful skin texture without altering natural expression.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'Because polynucleotides stimulate your own tissue repair, results are natural and durable. With periodic maintenance sessions, the improvements can be sustained indefinitely.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const ELIGIBILITY_SUITABLE = [
  'Ageing skin with loss of firmness, radiance, or elasticity',
  'Under-eye hollows or dark circles due to poor skin quality',
  'Skin laxity on the face, neck, décolletage, or hands',
  'Chronic skin dehydration and dullness',
  'Post-procedure healing and skin repair support',
];
...
const SKIN_CONCERNS_ADDRESSED = [
  {
    title: 'Under-eye Hollows',
    desc: 'PDRN regenerates the delicate periorbital tissue, improving hollow appearance and dark circles caused by thinning skin.',
  },
  {
    title: 'Fine Lines & Wrinkles',
    desc: 'Progressive collagen stimulation smooths surface lines and restores youthful skin texture across the face and neck.',
  },
  {
    title: 'Skin Dehydration',
    desc: 'Polynucleotides dramatically improve deep hydration, leaving skin plump, radiant, and resilient against environmental stress.',
  },
  {
    title: 'Loss of Elasticity',
    desc: 'Elastin production is revived to restore the skin\'s natural bounce and firmness, reversing early signs of sagging.',
  },
  {
    title: 'Dull Complexion',
    desc: 'Cellular renewal and improved microcirculation restore luminosity, giving skin a healthy, rested, and energised glow.',
  },
  {
    title: 'Acne Scars',
    desc: 'Tissue repair and remodelling at the injection site reduce the appearance of acne scarring and post-inflammatory marks.',
  },
  {
    title: 'Neck & Décolletage Ageing',
    desc: 'Crepey, thin skin on the neck and chest responds well to polynucleotides, with notable firming and texture improvement.',
  },
];

const TREATMENT_AREAS_FACE_BODY = [
  'Full face',
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'Most adults concerned about skin quality decline, dehydration, fine lines, or loss of elasticity are suitable candidates. Treatment is not recommended for those with a fish or seafood allergy, active skin infections, pregnancy or breastfeeding, or certain autoimmune conditions. A consultation with our doctors will confirm your suitability.',
  },
  {
    question: 'How many sessions will I need?',
    answer:
      'A course of 3 to 4 sessions spaced 2 to 4 weeks apart is typically recommended for optimal results. This sequential approach builds collagen progressively. Following the initial course, maintenance sessions every 3 to 6 months sustain results long term. Your doctor will tailor the protocol to your individual skin goals.',
  },
  {
    question: 'When will I see results from polynucleotide treatment?',
    answer:
      'Initial improvements in hydration and skin quality are usually visible within 2 to 4 weeks as cellular regeneration activates. Results deepen progressively over 8 to 12 weeks as collagen and elastin production builds. Optimal outcomes are typically evident after the full course of treatment.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Polynucleotides are primarily bio-stimulators: they trigger your own cells to regenerate tissue rather than adding volume. Profhilo is a hybrid hydrating and bio-remodelling treatment, while dermal fillers restore lost volume. Polynucleotides are particularly effective for overall skin quality, under-eye hollows, and areas where cellular repair is the priority. Many patients combine all three for comprehensive rejuvenation.',
  },
];
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="Polynucleotides (PDRN) Leicester, hero"
      ...
      {/* ════════════════════════════════════════
          4. OUR POLYNUCLEOTIDES APPROACH
      ════════════════════════════════════════ */}
          ...
          >
            ...
            <motion.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <p className={styles.resultsAfterCardBody}>
                Mild redness and minimal swelling may occur for 24 to 48 hours immediately after treatment. Initial improvements in hydration and skin texture appear within 2 to 4 weeks as cellular regeneration activates.
              </p>
            ...
            <motion.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <p className={styles.resultsAfterCardBody}>
                Polynucleotides are highly biocompatible. Most patients experience only minor, temporary effects:
              </p>
            ...
            <motion.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <ul className={styles.resultsAfterCardList} role="list">
                {[
                  ...
                  'Follow your doctor\'s specific aftercare advice',
                ].map((item) => (
                  <li key={item} className={styles.resultsAfterCardListItem}>
                    <span className={styles.resultsAfterDot} aria-hidden="true" />
                    {item}
      ...
      {/* ════════════════════════════════════════
          12. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book polynucleotides consultation">
        {/* Watermark logo */}
      ...
      <Section variant="dark" data-section-theme="dark" className={styles.conditionsSection}>
        <Container>
          ...
          >
            ...
            >
              <p className={styles.areasGroupLabel}>Face &amp; Body Areas</p>
              <ul className={styles.areasGroupList} role="list">
                {TREATMENT_AREAS_FACE_BODY.map((area) => (
            ...
            >
              ...
              <ul className={styles.areasGroupList} role="list">
                {TREATMENT_AREAS_CONCERNS.map((area) => (
                  <li key={area} className={styles.areasGroupItem}>
                    <span className={styles.areasItemDot} aria-hidden="true" />
                    {area}
                  </li>
      ...
      {/* ════════════════════════════════════════
          14. BEST POLYNUCLEOTIDES LEICESTER EXPERIENCE
      ════════════════════════════════════════ */}
