...
const JOURNEY_STEPS = [
  {
    ...
    desc: 'Our medical team discusses your skin concerns and goals. Your skin type is assessed to ensure Lumecca IPL is suitable and to determine the optimal treatment settings for your skin.',
  },
  {
    n: '02',
    title: 'Preparation',
    desc: 'The treatment area is cleansed thoroughly. A cooling gel is applied to the skin for comfort during the procedure. Protective eyewear is provided.',
  },
  {
    n: '03',
    title: 'Lumecca IPL Treatment',
    desc: 'The Lumecca IPL handpiece delivers broad-spectrum light pulses to target pigmentation and vascular lesions. The light energy breaks down pigment and stimulates collagen, typically lasting 30 to 45 minutes.',
  },
  {
    n: '04',
    title: 'Post-Treatment Care',
    desc: 'A soothing cream is applied and aftercare instructions provided. You can return to normal activities immediately. Sun protection is recommended as the skin heals.',
  },
];
...
const BENEFITS = [
  {
    ...
    desc: 'Most patients see significant improvement within days. Pigmentation darkens and naturally sheds as the skin regenerates, revealing clearer, more even-toned skin.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <circle cx="12" cy="12" r="10"/>
        <polyline points="12 6 12 12 16 14"/>
  ...
  {
    title: 'No Downtime',
    desc: 'Lumecca IPL is a true lunchtime treatment. Return to work, socialising, and your normal routine immediately with minimal discomfort.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
        <line x1="16" y1="2" x2="16" y2="6"/>
  ...
  },
  {
    ...
    desc: 'One device targets pigmentation, sun spots, rosacea, broken capillaries, and uneven skin tone in a single session, making it highly versatile.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    title: 'Most Powerful IPL Available',
    desc: 'Lumecca is the most powerful intense pulsed light device available, delivering up to three times more energy than conventional systems for faster, more effective results.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    title: 'Clinically Proven and Safe',
    desc: 'Lumecca is trusted by medical professionals worldwide. Delivered by our expert clinical team, it has a proven safety profile when used appropriately on suitable skin types.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    title: 'Non-Invasive with Lasting Benefits',
    desc: 'No needles, no surgery, no incisions. Lumecca stimulates your skin\'s natural collagen production, delivering improvements that continue to develop over weeks.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/>
        <polyline points="17 6 23 6 23 12"/>
...
const ELIGIBILITY = [
  'Concerned about pigmentation, sun damage, or age spots',
  'Dealing with rosacea, broken capillaries, or uneven redness',
  'Looking for a quick, no-downtime treatment',
  'Have lighter to medium skin tones (Fitzpatrick I to III)',
  'Wanting to boost skin clarity and radiance without surgery',
];

const TREATABLE_SKIN_CONCERNS = [
  'Pigmentation and Age Spots',
  'Sun Damage and UV-Induced Changes',
...
const FAQS = [
  {
    ...
    answer:
      'Lumecca is an intense pulsed light (IPL) device that uses broad-spectrum light to target and break down pigmentation, redness, and vascular lesions in the skin. It is one of the most powerful IPL systems available, delivering faster and more noticeable results than traditional light therapies.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Lumecca IPL is most effective for lighter skin tones (Fitzpatrick I to III). A thorough consultation and skin assessment is carried out before treatment to confirm suitability and ensure the safest, most effective settings are used.',
  },
  {
    question: 'Do I need a referral for Lumecca IPL?',
    answer:
      'No referral is needed. You can book directly with us. A full medical consultation is included before any treatment begins to ensure Lumecca IPL is appropriate for your skin concerns.',
  },
  {
    question: 'What is the downtime?',
    answer:
      'Lumecca IPL has no downtime. You can return to work and normal activities immediately. Some patients experience mild redness that typically resolves within a few hours.',
  },
  {
    question: 'How many sessions do I need?',
    answer:
      'Most patients see excellent results after a single session. However, depending on the skin concern and desired outcome, a series of 2 to 3 treatments spaced 3 to 4 weeks apart may be recommended for optimal results.',
  },
  {
...
const BA_IMAGES = [
  { src: '/images/Lumecca IPL B-A.jpg', alt: 'Lumecca IPL before and after result at The One Clinic Leicester' },
];
  ...
  return (
    <>
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <m.p className={styles.heroDesc} variants={fadeUp}>
                The most powerful IPL treatment available. Clear pigmentation, sun damage, and
                redness with no downtime and no recovery period.
              </m.p>
            ...
            <m.div className={styles.heroImageWrap} variants={fadeUp}>
              <Image
                src="/images/Lumecca IPL Laser 1.png"
                alt="Lumecca IPL skin treatment at The One Clinic Leicester"
                fill
                priority
          ...
          >
            <m.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <m.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <p className={styles.combinedDesc}>
                  ...
                  capillaries, producing remarkable results in fewer sessions with no downtime.
                </p>
              </m.div>
            ...
            <m.div className={styles.whatIsImageWrap} variants={fadeUp}>
              <Image
                ...
                alt="What is Lumecca IPL treatment at The One Clinic"
                fill
      ...
      <Section variant="light" data-section-theme="light" className={styles.journeySection}>
        <Container>
          ...
          <m.ol
            ...
            whileInView="show"
            viewport={VIEWPORT}
            aria-label="Lumecca IPL treatment journey steps"
          >
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.eyebrowDark} variants={fadeUp}>Why Lumecca</m.p>
            <m.h2 className={styles.headingDark} variants={fadeUp}>
        ...
        <Container>
          ...
          >
            <m.p className={styles.eligibilityIntro} variants={fadeUp}>
              Lumecca IPL may be right for you if you are:
            </m.p>
            ...
            <m.p className={styles.eligibilityClosing} variants={fadeUp}>
              Book a consultation and our team will assess your skin and confirm whether Lumecca IPL is the right treatment for you.
            </m.p>
            <m.div variants={fadeUp}>
      ...
      <Section variant="dark" data-section-theme="dark">
        <Container>
          ...
          >
            ...
            <m.h2 className={styles.headingLight} variants={fadeUp}>
              What Can Lumecca IPL Treat?
            </m.h2>
            <m.p className={styles.conditionsIntro} variants={fadeUp}>
              Lumecca IPL addresses a wide range of skin concerns and can be applied
              to multiple facial and neck areas.
            </m.p>
          </m.div>
          ...
          >
            ...
            >
              ...
              <ul className={styles.areasGroupList} role="list">
                {TREATABLE_SKIN_CONCERNS.map((item) => (
      ...
      <BeforeAfterSlideshow
        heading={"Lumecca IPL Before & After"}
        description={"Real pigmentation and skin clarity results from our patients at The One Clinic, Leicester."}
        images={BA_IMAGES}
        defaultTitle={"Lumecca IPL"}
      />
        ...
        <Container>
          ...
          >
            <m.div className={styles.clinicIntroLeft} variants={fadeUp}>
              <p className={styles.eyebrowLight}>Lumecca IPL</p>
              <h2 className={styles.headingLight}>
                Best Lumecca IPL<br />in Leicester
              </h2>
            </m.div>
            <m.p className={styles.clinicIntroDesc} variants={fadeUp}>
              The One Clinic delivers expert Lumecca IPL treatment in Leicester, combining
              advanced technology with personalised medical care. Our experienced doctors assess
              your skin thoroughly, plan every treatment to your specific concerns and type, and ensure
              safe, effective results in a clinical environment you can trust.
            </m.p>
          </m.div>
        </Container>
      </Section>
      ...
      <Section variant="dark" data-section-theme="dark">
        <Container>
          ...
          >
            <m.h2 className={styles.headingLight} variants={fadeUp}>
              Why Choose The One Clinic For Lumecca IPL
            </m.h2>
          </m.div>
