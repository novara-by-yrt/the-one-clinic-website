...
const FAQS = [
  {
    ...
    answer:
      'Joint injections are used to treat a range of conditions including osteoarthritis, rheumatoid arthritis, bursitis, tendinitis, and general joint inflammation. They are suitable for most major joints including the knee, hip, shoulder, elbow, ankle, and wrist. A consultation with our doctor will confirm whether injections are appropriate for your condition.',
  },
  {
    question: 'How long does the procedure take?',
    answer:
      'The injection itself typically takes only a few minutes. Including preparation, aftercare guidance, and any required monitoring, you should allow approximately 30 minutes for your appointment.',
  },
  {
...
export default function JointInjectionsPage() {
  return (
    <>
          ...
          >
            ...
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Joint Injection Treatment in Leicester
              </motion.h1>
      ...
      {/* ════════════════════════════════════════
          3. WHAT IS JOINT INJECTION TREATMENT?
      ════════════════════════════════════════ */}
        ...
        <Container className={styles.whiteBgContent}>
          ...
          >
            ...
            <motion.h2 className={styles.headingDark} variants={fadeUp}>
              Benefits of Joint Injection Treatment
            </motion.h2>
          </motion.div>
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Stop Living With<br />Joint Pain Today.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Let our expert doctors create a personalised joint injection plan for you.
            </motion.p>
            <motion.div variants={fadeUp}>
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              ...
              discussed in full during your consultation.
            </motion.p>
            <motion.div variants={fadeUp}>
              <BookConsultationButton className={styles.ctaBannerBtn}>
                Book A Consultation
