...
const RELATED = [
  ...
  { title: 'Lipoma Removal',       href: '/treatments/lipoma-removal',       desc: 'Safe in-clinic excision of fatty lumps causing discomfort or cosmetic concern.' },
  ...
  { title: 'Haemorrhoid Removal',  href: '/treatments/haemorrhoid-removal',  desc: 'In-clinic haemorrhoid treatment for lasting relief without hospital admission.' },
];
