...
const OVERVIEW_POINTS = [
  'Testosterone deficiency assessment and TRT management',
  'Erectile dysfunction and sexual health consultations',
  'Prostate health screening and PSA testing',
  'Cardiovascular risk assessment and lifestyle medicine',
];
...
const FAQS = [
  {
    ...
    answer:
      "Our men's health service covers a broad range of concerns including testosterone deficiency (low T) and TRT (testosterone replacement therapy), erectile dysfunction, premature ejaculation, sexual health screening and STI testing, prostate health and PSA blood tests, fertility concerns, hair loss, mental health and stress, cardiovascular risk assessment, and general men's health MOTs.",
  },
  {
    question: 'Can I be tested for low testosterone?',
    answer:
      'Yes. A simple blood test can measure your testosterone levels along with other relevant hormones. If testosterone deficiency is confirmed and you are experiencing symptoms such as fatigue, low libido, mood changes, or reduced muscle mass, our doctors can discuss whether testosterone replacement therapy (TRT) is appropriate for you and manage your treatment safely with regular monitoring.',
  },
  {
          ...
          >
            ...
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Men's Health Clinic in Leicester
              </motion.h1>
          ...
          >
            ...
            <motion.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <motion.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <h2 className={styles.combinedHeading}>What is a Men's Health Consultation?</h2>
                <p className={styles.combinedDesc}>
                  Our men's health service provides a private, dedicated space for men to address
                  health concerns that are often left too long without attention. Whether you are
                  dealing with hormonal issues, sexual health worries, cardiovascular risk, or
                  simply want a thorough health MOT, our experienced doctors offer straightforward,
                  evidence-based care tailored specifically to men at every stage of life.
                </p>
              </motion.div>
        ...
        <Container className={styles.whiteBgContent}>
          ...
          >
            ...
            <motion.h2 className={styles.headingDark} variants={fadeUp}>
              Benefits of Our Men's Health Service
            </motion.h2>
          </motion.div>
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Pricing varies depending on the nature of your consultation and any tests or
              treatments required. All costs are discussed clearly before your appointment.
            </motion.p>
            <motion.div variants={fadeUp}>
              <BookConsultationButton className={styles.ctaBannerBtn}>
                Book A Consultation
