...
const BENEFITS = [
  {
    title: 'A Safe, Non-Judgemental Space',
    desc: 'We provide a calm, confidential environment where you can speak openly. Our doctors listen without judgement and take your mental wellbeing as seriously as your physical health.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Our doctors consider both your mental and physical health together. Dr Gunjan Bedi holds dual qualifications in General Practice and Psychiatry, bringing a uniquely comprehensive perspective to every consultation.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    title: 'Ongoing Support & Referrals',
    desc: 'We provide continuity of care through regular follow-up appointments and can arrange prompt referrals to psychiatrists, psychologists, or talking therapists where specialist input is needed.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const OVERVIEW_POINTS = [
  'Assessment and support for anxiety, depression, and stress',
  'Medication review and prescriptions where clinically appropriate',
  'Specialist referrals to psychiatrists and therapists',
  'Seen by a doctor with qualifications in both GP and psychiatry',
];
...
export default function MentalHealthPage() {
  return (
    <>
          ...
          >
            ...
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Mental Health Consultation in Leicester
              </motion.h1>
      ...
      {/* ════════════════════════════════════════
          3. WHAT IS A MENTAL HEALTH CONSULTATION?
      ════════════════════════════════════════ */}
          ...
          >
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="Compassionate doctor at The One Clinic ready to help"
                fill
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>
              Consultations From £85
            </motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Initial appointments are longer to allow for a thorough assessment. Pricing is
