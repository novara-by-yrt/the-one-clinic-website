...
const JOURNEY_STEPS = [
  {
    ...
    desc: 'Our medical team assesses your skin type, concerns, and goals in detail. A personalised treatment plan is created specifying laser settings, depth, and the areas to be treated.',
  },
  {
    n: '02',
    title: 'Preparation and Numbing',
    desc: 'The skin is thoroughly cleansed and a topical anaesthetic is applied to maximise comfort. Protective eyewear is provided and the treatment area is prepared for the procedure.',
  },
  {
    n: '03',
    title: 'Laser Resurfacing Treatment',
    desc: 'The laser precisely removes damaged skin layers and delivers controlled heat to the dermis, triggering the body\'s natural collagen repair response. Treatment typically takes 60 to 90 minutes.',
  },
  {
    n: '04',
    title: 'Post-Treatment Care and Recovery',
    desc: 'Soothing products are applied and detailed aftercare instructions are provided. Your skin will heal over 5 to 10 days as new, healthier skin regenerates beneath the surface.',
  },
];
...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'The new collagen stimulated by deep resurfacing continues to mature for months after treatment, with results that can last several years with proper care.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/>
        <polyline points="17 6 23 6 23 12"/>
  ...
  },
  {
    ...
    desc: 'Deep laser resurfacing requires advanced clinical expertise. At The One Clinic, all treatments are planned and delivered by our experienced GMC-registered medical team.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'The controlled laser energy activates your skin\'s natural repair process, producing fresh collagen that gradually improves firmness, elasticity, and resilience over time.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    title: 'Improved Tone and Texture',
    desc: 'Redness, blotchiness, rough patches, and enlarged pores are all significantly reduced, leaving skin with a more uniform and refined appearance.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const ELIGIBILITY = [
  'Looking for significant improvement in deep wrinkles or pronounced lines',
  'Dealing with acne scars, sun damage, or stubborn pigmentation',
  'Wanting long-lasting results from a single comprehensive treatment',
  'Committed to following post-treatment aftercare guidelines during recovery',
  'Seeking medical-grade skin renewal under expert clinical supervision',
];
...
const FAQS = [
  ...
  {
    question: 'Is deep laser resurfacing painful?',
    answer:
      'A topical anaesthetic cream is applied before treatment to ensure you are as comfortable as possible. Most patients describe a warm or tingling sensation during the procedure rather than sharp pain. Our team monitors your comfort throughout.',
  },
  {
    question: 'When will I see results?',
    answer:
      'Initial improvements in skin texture and tone are visible within 2 to 4 weeks as the skin heals. The full benefit of the collagen remodelling response continues to develop over 3 to 6 months, with results lasting several years.',
  },
  {
    question: 'Who is not suitable for deep laser resurfacing?',
    answer:
      'Deep laser resurfacing may not be suitable for patients with very dark skin tones, active skin infections, certain skin conditions, or those taking medications that affect healing. A full medical consultation is carried out to assess your suitability.',
  },
  {
...
export default function LaserResurfacingPage() {
  ...
  return (
    <>
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <motion.h1 className={styles.heroTitle} variants={fadeUp}>
                Deep Laser Resurfacing<br />in Leicester
              </motion.h1>

              <motion.p className={styles.heroDesc} variants={fadeUp}>
                Transformative skin renewal for wrinkles, scars, and sun damage. Advanced
                laser resurfacing delivering dramatic, long-lasting results under expert
                medical supervision.
              </motion.p>
      ...
      {/* ════════════════════════════════════════
          2. WHAT IS DEEP LASER RESURFACING?
      ════════════════════════════════════════ */}
            ...
            <motion.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <motion.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <p className={styles.combinedDesc}>
                  Deep laser resurfacing is one of the most powerful skin renewal treatments
                  available. High-energy laser beams precisely remove damaged skin layers while
                  simultaneously stimulating deep collagen remodelling, resulting in dramatically
                  smoother, firmer, and more radiant skin. At The One Clinic, all treatments are
                  tailored to your skin type and concerns by our expert medical team.
                </p>
              </motion.div>
        ...
        <Container className={styles.whiteBgContent}>
          ...
          >
            ...
            <motion.h2 className={styles.headingDark} variants={fadeUp}>
              Deep Laser Resurfacing at a Glance
            </motion.h2>
          </motion.div>
      ...
      <Section variant="light" data-section-theme="light" className={styles.journeySection}>
        <Container>
          ...
          <motion.ol
            ...
            whileInView="show"
            viewport={VIEWPORT}
            aria-label="Deep laser resurfacing treatment journey steps"
          >
        ...
        <Container>
          ...
          >
            <motion.p className={styles.eligibilityIntro} variants={fadeUp}>
              Deep laser resurfacing may be right for you if you are:
            </motion.p>
            ...
            <motion.p className={styles.eligibilityClosing} variants={fadeUp}>
              Book a consultation and our team will assess your skin and confirm whether deep laser resurfacing is the right treatment for you.
            </motion.p>
            <motion.div variants={fadeUp}>
          ...
          >
            <motion.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <p className={styles.resultsAfterCardBody}>
                Initial skin improvements become visible within 2 to 4 weeks as the surface
                heals and new skin emerges. The full collagen remodelling response continues
                to develop over 3 to 6 months.
              </p>
              <div className={styles.resultsAfterCardSpacer} />
              <p className={styles.resultsAfterCardNote}>
                Results from a single deep resurfacing session can last several years with
                good sun protection and skincare.
              </p>
            </motion.div>
            ...
            <motion.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <ul className={styles.resultsAfterCardList} role="list">
                {[
                  ...
                  'Peeling and skin flaking as new skin forms',
              ...
              <div className={styles.resultsAfterCardSpacer} />
              <p className={styles.resultsAfterCardNote}>
                These are normal parts of the healing process and typically resolve within 5 to 10 days.
              </p>
            </motion.div>
            ...
            <motion.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <ul className={styles.resultsAfterCardList} role="list">
                {[
                  'Keep the skin moisturised and avoid picking or scratching',
                  'Apply SPF 50 every day once the skin has healed',
                  'Avoid direct sun exposure for at least 4 weeks',
                  'Do not use retinoids or active skincare for 2 to 4 weeks post-treatment',
                  'Attend your follow-up appointment so our team can monitor healing',
                ].map((item) => (
                  <li key={item} className={styles.resultsAfterCardListItem}>
                    <span className={styles.resultsAfterDot} aria-hidden="true" />
                    {item}
      ...
      <Section variant="dark" data-section-theme="dark" className={styles.conditionsSection}>
        <Container>
          ...
          >
            ...
            <motion.h2 className={styles.headingLight} variants={fadeUp}>
              What Can Deep Laser Resurfacing Treat?
            </motion.h2>
            <motion.p className={styles.conditionsIntro} variants={fadeUp}>
              Deep laser resurfacing addresses a wide range of skin concerns and can
              be applied to multiple facial and neck areas.
            </motion.p>
          </motion.div>
        ...
        <Container>
          ...
          >
            <motion.div className={styles.clinicIntroLeft} variants={fadeUp}>
              <p className={styles.eyebrowLight}>Laser Resurfacing</p>
              <h2 className={styles.headingLight}>
                Best Laser Resurfacing<br />in Leicester
              </h2>
            </motion.div>
            <motion.p className={styles.clinicIntroDesc} variants={fadeUp}>
              The One Clinic delivers expert deep laser resurfacing in Leicester, combining
              advanced technology with personalised medical care. Our experienced doctors plan
              every treatment to your specific skin concerns and type, ensuring safe, effective
              results in a clinical environment you can trust.
            </motion.p>
          </motion.div>
        </Container>
      </Section>
