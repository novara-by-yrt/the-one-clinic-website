...
const AT_A_GLANCE = [
  ...
  },
  {
    ...
    value: '3 sessions (4 to 6 weeks apart)',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const JOURNEY_STEPS = [
  {
    ...
    desc: 'Our medical team carries out a full skin consultation to understand your concerns and goals. Your skin type is assessed and a personalised treatment plan is created.',
  },
  {
    n: '02',
    title: 'Blood Draw and PRP Processing',
    desc: 'A small sample of your blood is drawn, typically from the arm. The blood is processed in a centrifuge to separate and concentrate the platelet-rich plasma containing growth factors.',
  },
  {
    n: '03',
    title: 'Micro-Needling with PRP Application',
    desc: 'Using a medical-grade micro-needling device, controlled micro-injuries are created on the skin surface. The PRP is applied during this process, allowing growth factors to penetrate deep into the dermis.',
  },
  {
    n: '04',
    title: 'Post-Treatment Skincare and Recovery',
    desc: 'Soothing products are applied and detailed aftercare instructions provided. Most patients experience mild redness for 24 to 48 hours. Results develop gradually over the following weeks as collagen remodels.',
  },
];
...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'PRP growth factors trigger deep collagen and elastin remodelling, improving skin firmness, fine lines, texture, and overall radiance over weeks following treatment.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <circle cx="12" cy="12" r="10"/>
        <polyline points="12 6 12 12 16 14"/>
  ...
  },
  {
    ...
    desc: 'Most patients experience only mild redness for 24 to 48 hours following treatment. Normal activities can typically be resumed the same day or next day.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
        <line x1="16" y1="2" x2="16" y2="6"/>
  ...
  },
  {
    ...
    desc: 'At The One Clinic, all Vampire Facial treatments are planned and delivered by our experienced medical team. A full skin consultation is carried out before any procedure.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    desc: 'Initial improvements in skin texture and tone appear within 2 to 4 weeks. Full benefits develop over 8 to 12 weeks as collagen production continues.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    title: 'No Synthetic Products',
    desc: 'The Vampire Facial uses only PRP from your own blood and natural micro-needling. No fillers, no toxins, no foreign substances introduced into your skin.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const ELIGIBILITY = [
  'Looking for natural skin rejuvenation using your own biological healing response',
  'Wanting to improve fine lines, wrinkles, texture, and skin tone',
  'Seeking collagen stimulation without invasive surgery or synthetic products',
  'Ready to commit to a course of 3 treatments for optimal results',
  'Wanting expert-led care from medical professionals with full skin assessment',
];
...
const TREATABLE_CONCERNS = [
  ...
  'Poor Skin Texture and Roughness',
  'Overall Skin Aging and Loss of Radiance',
];
...
const FAQS = [
  {
    question: 'What is a Vampire Facial?',
    answer:
      'A Vampire Facial (PRP facial) uses platelet-rich plasma derived from a small sample of your own blood. The PRP is processed to concentrate growth factors, then applied to the skin using micro-needling. This stimulates the skin\'s natural repair process, triggering collagen production for improved texture, tone, and firmness.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Initial improvements in skin texture and tone are often noticeable within 2 to 4 weeks. Full benefits continue to develop over 8 to 12 weeks as collagen remodelling progresses. Results improve progressively with each treatment in the course.',
  },
  {
    question: 'Can Vampire Facial be combined with other treatments?',
    answer:
      'Yes, Vampire Facial can be effectively combined with other treatments such as chemical peels, dermal fillers, or other regenerative therapies. Your doctor will advise on the best combination approach based on your skin assessment.',
  },
  {
    question: 'Who is not suitable for Vampire Facial?',
    answer:
      'Vampire Facial is not suitable for those with certain blood disorders, active skin infections, or those taking blood-thinning medications. A full medical assessment is carried out at your consultation to ensure the treatment is safe for you.',
  },
  {
    question: 'Do I need a referral for a Vampire Facial?',
    answer:
      'No referral is needed. You can book directly with The One Clinic. A full skin consultation and medical assessment is carried out before any treatment to ensure the Vampire Facial is the right option for you.',
  },
];
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="Vampire Facial Leicester, hero"
          ...
          >
            <div className={styles.heroLeft}>
              ...
              <m.h1 className={styles.heroTitle} variants={fadeUp}>
                Vampire Facial<br />in Leicester
              </m.h1>

              <m.p className={styles.heroDesc} variants={fadeUp}>
                Natural PRP skin rejuvenation using your own platelet-rich plasma. Restore
                radiance, improve texture, and stimulate collagen with expert-led treatment.
              </m.p>
          ...
          >
            <m.div className={styles.whatIsContent} variants={stagger(0.12)}>
              <m.div className={styles.whatIsTextGroup} variants={fadeUp}>
                ...
                <h2 className={styles.combinedHeading}>What is a Vampire Facial?</h2>
                <p className={styles.combinedDesc}>
                  The Vampire Facial combines micro-needling with platelet-rich plasma (PRP)
                  derived from your own blood. PRP is packed with growth factors that signal
                  the skin to repair and regenerate, stimulating collagen and elastin production
                  for visibly smoother, firmer, and more radiant skin. At The One Clinic, every
                  treatment is tailored to your skin by our expert medical team.
                </p>
              </m.div>
      ...
      <Section variant="light" data-section-theme="light" className={styles.journeySection}>
        <Container>
          ...
          <m.ol
            ...
            whileInView="show"
            viewport={VIEWPORT}
            aria-label="Vampire Facial treatment journey steps"
          >
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.eyebrowDark} variants={fadeUp}>Why Vampire Facial</m.p>
            <m.h2 className={styles.headingDark} variants={fadeUp}>
              The Benefits of Vampire Facial
            </m.h2>
          </m.div>
        ...
        <Container>
          ...
          >
            <m.p className={styles.eligibilityIntro} variants={fadeUp}>
              Vampire Facial may be right for you if you are:
            </m.p>
            ...
            <m.p className={styles.eligibilityClosing} variants={fadeUp}>
              Book a consultation and our team will assess your skin and confirm whether Vampire Facial is the right treatment for you.
            </m.p>
            <m.div variants={fadeUp}>
          ...
          >
            <m.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <p className={styles.resultsAfterCardBody}>
                Initial improvements in skin texture and tone appear within 2 to 4 weeks.
                Full benefits develop over 8 to 12 weeks as collagen production continues
                and new skin regenerates. Results improve progressively with each session.
              </p>
              <div className={styles.resultsAfterCardSpacer} />
              <p className={styles.resultsAfterCardNote}>
                A course of 3 treatments spaced 4 to 6 weeks apart delivers the most
                dramatic results.
              </p>
            </m.div>
            ...
            <m.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <ul className={styles.resultsAfterCardList} role="list">
                {[
                  'Mild to moderate redness for 24 to 48 hours',
                  'Slight swelling or puffiness in treated areas',
                  'Mild sensitivity and tightness of skin',
                  'Possible light bruising from blood draw',
                ].map((item) => (
              ...
              <div className={styles.resultsAfterCardSpacer} />
              <p className={styles.resultsAfterCardNote}>
                Side effects are typically mild and resolve within 1 to 2 days, allowing
                normal activities to resume quickly.
              </p>
            </m.div>
            ...
            <m.div className={styles.resultsAfterCard} variants={fadeUp}>
              ...
              <ul className={styles.resultsAfterCardList} role="list">
                {[
                  'Keep skin clean and avoid harsh products for 24 hours',
                  'Apply hydrating serums and gentle moisturiser',
                  'Avoid strenuous exercise for 24 to 48 hours',
                  'Protect skin from direct sun with SPF 50',
      ...
      {/* ════════════════════════════════════════
          9. CTA BANNER
      ════════════════════════════════════════ */}
      <section className={styles.ctaBanner} data-section-theme="dark" aria-label="Book Vampire Facial">
        ...
        <Container>
          ...
          >
            <m.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Glow From Within.<br />Naturally.
            </m.h2>
            <m.p className={styles.ctaBannerSub} variants={fadeUp}>
              Book a Vampire Facial consultation with our expert team in Leicester.
            </m.p>
            <m.div variants={fadeUp}>
      ...
      <Section variant="dark" data-section-theme="dark" className={styles.conditionsSection}>
        <Container>
          ...
          >
            ...
            <m.h2 className={styles.headingLight} variants={fadeUp}>
              What Can Vampire Facial Treat?
            </m.h2>
            <m.p className={styles.conditionsIntro} variants={fadeUp}>
              Vampire Facial addresses a wide range of skin aging concerns and can be
              applied to multiple facial and body areas for comprehensive rejuvenation.
            </m.p>
          </m.div>
        ...
        <Container>
          ...
          >
            <m.div className={styles.clinicIntroLeft} variants={fadeUp}>
              <p className={styles.eyebrowLight}>Vampire Facial</p>
              <h2 className={styles.headingLight}>
                Best PRP Facial<br />in Leicester
              </h2>
            </m.div>
            <m.p className={styles.clinicIntroDesc} variants={fadeUp}>
              The One Clinic delivers expert Vampire Facial treatment in Leicester, combining
              advanced PRP technology with personalised clinical care. Our experienced doctors
              tailor every treatment course to your specific skin needs, ensuring natural, safe
              rejuvenation in a clinical environment you can trust.
            </m.p>
          </m.div>
        </Container>
      </Section>
      ...
      {/* ════════════════════════════════════════
          12. COST BANNER
      ════════════════════════════════════════ */}
      <section className={styles.costBanner} data-section-theme="dark" aria-label="Vampire Facial cost">
        <Container>
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.costBannerEyebrow} variants={fadeUp}>Vampire Facial Pricing at The One Clinic</m.p>
            <m.p className={styles.costBannerPrice} variants={fadeUp}>From £250</m.p>
      ...
      <Section variant="dark" data-section-theme="dark">
        <Container>
          ...
          >
            <m.h2 className={styles.headingLight} variants={fadeUp}>
              Why Choose The One Clinic For Vampire Facial
            </m.h2>
          </m.div>
