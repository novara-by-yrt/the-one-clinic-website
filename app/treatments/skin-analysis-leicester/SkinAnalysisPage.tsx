...
const RELATED = [
  ...
  { title: 'NCTF 135 HA',        href: '/treatments/nctf-135-ha-leicester',       desc: 'Skin revitalisation with polynucleotides and hyaluronic acid.' },
  { title: 'AlumierMD Skincare', href: '/treatments/alumiermd',         desc: 'Medical-grade personalised skincare programmes.' },
  { title: 'Dermatologist',      href: '/treatments/dermatologist-leicester',     desc: 'Expert dermatology consultations and skin health assessments.' },
];
      ...
      <Section variant="light" data-section-theme="light" className={styles.howSection}>
        <Container>
          ...
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.howCoversLabel} variants={fadeUp}>Parameters Measured by the Life Viz 3D</m.p>
