...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'We focus on sustainable weight loss, not quick fixes. By addressing the underlying habits and health factors, our programmes help you maintain results for the long term.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const OVERVIEW_POINTS = [
  'Personalised medical weight loss programme',
  'Access to prescription medication where clinically appropriate',
  'Regular check-ins and progress monitoring with your doctor',
  'Nutritional guidance and sustainable lifestyle support',
];
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="Weight management Leicester, hero"
          ...
          >
            ...
            <div className={styles.heroLeft}>
              ...
              <motion.div className={styles.heroTrust} variants={fadeUp}>
                ...
                <span className={styles.heroTrustItem}>
                  ...
                  Personalised medical programmes
                </span>
                <span className={styles.heroTrustDivider} aria-hidden="true" />
                <span className={styles.heroTrustItem}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <motion.div className={styles.heroImageWrap} variants={fadeUp}>
              <Image
                ...
                alt="Weight management consultation at The One Clinic Leicester"
                fill
                priority
          ...
          >
            ...
            <motion.div className={styles.whatIsVideoWrap} variants={fadeUp}>
              <Image
                ...
                alt="Doctor conducting a weight management consultation"
                fill
      ...
      <Section variant="light" data-section-theme="light" className={styles.whiteBgSection}>
        ...
        <Container className={styles.whiteBgContent}>
          <motion.div
            ...
            viewport={VIEWPORT}
          >
            <motion.p className={styles.eyebrowDark} variants={fadeUp}>Why It Works</motion.p>
        ...
        <Container>
          ...
          >
            <motion.h2 className={styles.ctaBannerHeading} variants={fadeUp}>
              Start Your Weight Loss<br />Journey Today.
            </motion.h2>
            <motion.p className={styles.ctaBannerSub} variants={fadeUp}>
              Let our expert doctors build a programme that truly works for you.
            </motion.p>
            <motion.div variants={fadeUp}>
        ...
        <Container>
          ...
          >
            ...
            <motion.p className={styles.costBannerPrice} variants={fadeUp}>
              Initial Consultation From £75
            </motion.p>
            <motion.p className={styles.costBannerNote} variants={fadeUp}>
              Programme pricing varies depending on duration, support level, and whether
              prescription medication is included. Full costs are discussed transparently at your
              first appointment.
            </motion.p>
            <motion.div variants={fadeUp}>
              <BookConsultationButton className={styles.ctaBannerBtn}>
