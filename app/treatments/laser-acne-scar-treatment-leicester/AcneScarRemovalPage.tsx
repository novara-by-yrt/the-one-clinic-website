...
const RELATED = [
  { title: 'Morpheus8',           href: '/treatments/morpheus8-leicester',          desc: 'RF microneedling for skin tightening, texture, and collagen renewal.' },
      ...
      <Section variant="dark" data-section-theme="dark">
        <Container>
          <m.div
            ...
            viewport={VIEWPORT}
          >
            <m.p className={styles.eyebrowLight} variants={fadeUp}>Scar Types and Areas</m.p>
            <m.h2 className={styles.headingLight} variants={fadeUp}>
