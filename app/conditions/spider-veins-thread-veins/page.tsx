...
export const metadata: Metadata = {
  title: 'Spider Veins & Thread Veins Treatment Leicester | The One Clinic',
  description:
    'Learn about spider veins and thread veins and effective treatment options. GMC-registered doctors at The One Clinic, Leicester offer personalised treatments to reduce visible veins and restore clearer skin.',
  keywords: [
