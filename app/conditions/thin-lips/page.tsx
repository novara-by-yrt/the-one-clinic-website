...
export const metadata: Metadata = {
  title: 'Thin Lips Treatment Leicester | Fuller, Natural-Looking Lips',
  description: 'Learn about thin lips and effective treatment options. GMC-registered doctors at The One Clinic, Leicester offer personalised lip filler and aesthetic treatm…',
  keywords: [
  ...
  openGraph: {
    title: 'Thin Lips Treatment Leicester',
    description:
