...
const IMAGES = [
  ...
  { src: '/images/Endolift Before & After 2.jpg',     alt: 'Endolift before and after result',           title: 'Endolift' },
  { src: '/images/Endolift Before & After 3.jpg',     alt: 'Endolift before and after result',           title: 'Endolift' },
  { src: '/images/Endolift Before & After 4.jpg',     alt: 'Endolift before and after result',           title: 'Endolift' },
  { src: '/images/Endolift Before & After 5.jpg',     alt: 'Endolift before and after result',           title: 'Endolift' },
  { src: '/images/Endolift Before & After 6.jpg',     alt: 'Endolift before and after result',           title: 'Endolift' },
  { src: '/images/Endolift Before & After 7.jpg',     alt: 'Endolift before and after result',           title: 'Endolift' },
  ...
  { src: '/images/Botox Before & After.jpg',          alt: 'Anti-wrinkle injections before and after results', title: 'Anti-Wrinkle Injections' },
  { src: '/images/Botox Before & After-1.jpg',        alt: 'Anti-wrinkle injections before and after results', title: 'Anti-Wrinkle Injections' },
  { src: '/images/Botox Before & After-2.jpg',        alt: 'Anti-wrinkle injections before and after results', title: 'Anti-Wrinkle Injections' },
  { src: '/images/Botox Before & After-3.jpg',        alt: 'Anti-wrinkle injections before and after results', title: 'Anti-Wrinkle Injections' },
  { src: '/images/Botox Before & After-4.jpg',        alt: 'Anti-wrinkle injections before and after results', title: 'Anti-Wrinkle Injections' },
  { src: '/images/Botox Before & After-5.jpg',        alt: 'Anti-wrinkle injections before and after results', title: 'Anti-Wrinkle Injections' },
  { src: '/images/Botox Before & After-6.jpg',        alt: 'Anti-wrinkle injections before and after results', title: 'Anti-Wrinkle Injections' },
  ...
  { src: '/images/Hydrafacial  Before & After 1.jpg', alt: 'Hydrafacial before and after results',       title: 'Hydrafacial' },
  { src: '/images/Hydrafacial  Before & After 2.jpg', alt: 'Hydrafacial before and after results',       title: 'Hydrafacial' },
  { src: '/images/Lip Filler  Before & After.jpg',    alt: 'Lip filler before and after results',        title: 'Lip Filler' },
  { src: '/images/Lip Filler  Before & After 4.jpg',  alt: 'Lip filler before and after results',        title: 'Lip Filler' },
  { src: '/images/Lip Filler  Before & After 6.jpg',  alt: 'Lip filler before and after results',        title: 'Lip Filler' },
  { src: '/images/Filler  Before & After 1.jpg',      alt: 'Filler before and after results',            title: 'Filler' },
  { src: '/images/Filler  Before & After 2.jpg',      alt: 'Filler before and after results',            title: 'Filler' },
  { src: '/images/Non surgical rhinoplasty  Before & After.jpg',  alt: 'Non-surgical rhinoplasty before and after results', title: 'Non-Surgical Rhinoplasty' },
  { src: '/images/Non surgical rhinoplasty  Before & After1.jpg', alt: 'Non-surgical rhinoplasty before and after results', title: 'Non-Surgical Rhinoplasty' },
  { src: '/images/Pigmentation Before & After 1.jpg', alt: 'Pigmentation treatment before and after',    title: 'Pigmentation' },
  { src: '/images/Pigmentation Before & After 2.jpg', alt: 'Pigmentation treatment before and after',    title: 'Pigmentation' },
  ...
  { src: '/images/B-A9.png',                          alt: 'Patient before and after results',           title: 'Patient Results' },
];
