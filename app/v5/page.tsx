...
import V5Track from '@/components/v5/V5Track';
import V5HeroPanel from '@/components/v5/V5HeroPanel';
import V5Panel, { type Panel } from '@/components/v5/V5Panel';
import V5ClosingPanel from '@/components/v5/V5ClosingPanel';
import '@/components/v5/v5-tokens.css';

export const metadata: Metadata = {
  title: 'The One Clinic - V5 Concept',
