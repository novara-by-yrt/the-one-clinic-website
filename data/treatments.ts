...
export const treatments: Treatment[] = [
  {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Treatment takes 15–30 minutes with minimal discomfort. No anaesthetic required.',
      },
      {
        title: 'No Downtime',
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'Initial results are visible within 3–5 days. Full effect is seen at approximately 2 weeks, which is why we schedule a review appointment at this point.',
      },
      {
        question: 'How long do results last?',
        answer: 'Results typically last 3–4 months. This varies by individual and the area treated. Over time, with regular treatments, many patients find their results last longer.',
      },
      {
        question: 'Are there any side effects?',
        answer: 'Mild redness, swelling, or bruising at the injection site can occur but usually resolves within 24–48 hours. Serious side effects are rare when treatment is performed by a qualified practitioner.',
      },
    ],
  },
  {
    ...
    process: [
      ...
      },
      {
        number: '02',
        title: 'Preparation',
        description: 'The skin is cleansed and a topical anaesthetic cream is applied for 20–30 minutes prior to treatment for your comfort.',
      },
      {
        number: '03',
        title: 'Treatment',
  ...
  },
  {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Results continue to improve for 3–6 months post-treatment as collagen remodelling occurs.',
      },
    ],
    process: [
      {
      ...
      },
      {
        number: '02',
        title: 'Preparation',
        description: 'Depending on the treatment, a prescribed skincare programme may be required for 2–4 weeks prior to optimise results and minimise risk.',
      },
      {
        number: '03',
        title: 'Treatment',
        description: 'The laser is passed over the skin in a precise pattern. Cooling is applied throughout for comfort. Sessions typically last 30–60 minutes.',
      },
      {
        number: '04',
        title: 'Recovery & Review',
        description: 'A structured post-treatment skincare plan is provided. Results are reviewed at 4–6 weeks to assess progress and plan next steps.',
      },
    ],
    faq: [
      {
        question: 'How much downtime should I expect?',
        answer: 'This depends on the laser type and intensity. Non-ablative treatments may have no downtime. Ablative resurfacing may require 5–7 days of healing. Your practitioner will advise based on your selected protocol.',
      },
      {
      ...
      },
      {
        ...
        answer: 'This varies by concern and laser type. Some patients achieve their goals in a single session; others benefit from a course of 3–6 treatments spaced 4–8 weeks apart.',
      },
    ],
  },
  {
    ...
    process: [
      ...
      },
      {
        ...
        description: 'A course of 3 sessions, 4–6 weeks apart, is recommended. Progress photos are taken at each visit to track improvement.',
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer: 'After the initial course of 3 sessions, most patients benefit from a maintenance session every 6–12 months to sustain results.',
      },
    ],
  },
  {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Results develop over 6–12 weeks as the body naturally eliminates treated fat cells and rebuilds collagen.',
      },
    ],
    process: [
      {
      ...
      },
      {
        number: '03',
        title: 'Sessions',
        description: 'Treatment sessions are typically 45–90 minutes. Most programmes involve 4–8 sessions spaced 1–2 weeks apart.',
      },
      {
        number: '04',
  ...
  },
  {
    ...
    process: [
      ...
      },
      {
        number: '03',
        title: 'Infusion',
        description: 'A small cannula is placed in a vein and the infusion is delivered over 30–60 minutes while you relax.',
      },
      {
        number: '04',
        title: 'Ongoing Plan',
